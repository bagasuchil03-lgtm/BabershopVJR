...
<head>
    ...
    <title>Login - Vijer Barbershop</title>
    ...
    <style>
        ...
        body { background-color: var(--bg-color); color: var(--text-main); font-family: 'Inter', sans-serif; display: flex; align-items: center; justify-content: center; min-height: 100vh; transition: background-color 0.3s, color 0.3s; }
        .auth-card { background-color: var(--card-bg); border: 1px solid var(--border-color); border-radius: 15px; padding: 40px; width: 100%; max-width: 400px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); transition: background-color 0.3s; }
...
<body>
    ...
    <div class="auth-card text-center">
        ...
        <form action="auth_proses.php" method="POST">
            ...
            <button type="submit" class="btn btn-gold w-100 rounded-pill py-2 mb-3">Login</button>
        </form>
        <p class="text-muted-custom small">Belum punya akun? <a href="register.php">Daftar sekarang</a></p>
        <a href="index.php" class="text-muted-custom small"><i class="fas fa-arrow-left me-1"></i>Kembali ke Beranda</a>
    </div>
